...
export default function StealDeal() {
  ...
  return (
    <section className="relative w-full flex justify-center px-4 sm:px-6 md:px-10 py-10">
      {/* Curved Container */}
      <div
        className="relative w-[95%] max-w-7xl mx-auto min-h-[80vh] flex flex-col md:flex-row items-center overflow-hidden 
      ...
      >
        ...
        <div className="relative flex flex-col justify-center w-full md:w-1/2 min-h-[400px] md:min-h-[500px] z-20 text-left py-10">
          ...
          <p className="text-sm sm:text-base md:text-lg text-[#5A4E3C] mb-6 max-w-lg">
            Discover timeless furniture and décor — <br /> curated to make your home
            warm & inviting.
          </p>
        ...
        {/* 3D Carousel */}
        <div className="relative flex-1 min-h-[380px] sm:min-h-[450px] md:min-h-[550px] flex items-center justify-center overflow-hidden mt-8 md:mt-0">
          <div className="relative w-full flex items-center justify-center perspective-[1200px]">
            {validImages.map((img, idx) => {
              ...
              // Sizes controlled via tailwind and container styles for responsiveness
              let width = isMobile ? 160 : isTablet ? 200 : 240;
              let height = isMobile ? 200 : isTablet ? 260 : 300;
              ...
              return (
                <div
                  key={img.id}
                  className="absolute transition-all duration-700 ease-in-out rounded-xl overflow-hidden bg-white shadow-lg"
                  style={{
